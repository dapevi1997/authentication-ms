...
import co.com.crediya.api.util.Roles;
...
class SecurityConfigTest {
    ...
    @Test
    @DisplayName("Constantes debe tener URL_REGISTER_USER definida")
    void constantes_ShouldHaveRegisterUserUrlDefined() {
        // Assert
        assertThat(Constantes.URL_REGISTER_USER).isEqualTo("/api/v1/usuarios");
    }
